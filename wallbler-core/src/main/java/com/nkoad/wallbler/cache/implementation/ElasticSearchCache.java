...
public class ElasticSearchCache implements Cache {
    ...
    public void add(Set<WallblerItem> wallblerItems) {
        ...
        String payloadForAdding = generateBulkPayloadForAdding(wallblerItems, existedPostsId.getRecent()); // TODO : allow to add posts with changed number of likes, comments, shared (need to update them)
